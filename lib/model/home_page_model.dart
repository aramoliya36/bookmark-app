...
class HomePageModel {
  ...
  factory HomePageModel.fromJson(Map<String, dynamic> json) => HomePageModel(
        ...
        count: json["count"],
        response: List<HomeResponse>.from(
            json["response"].map((x) => HomeResponse.fromJson(x))),
      );
...
class HomeResponse {
  ...
  factory HomeResponse.fromJson(Map<String, dynamic> json) => HomeResponse(
        ...
        publisher: List<Publisher>.from(
            json["publisher"].map((x) => Publisher.fromJson(x))),
        responseClass:
        ...
        popupScreen: List<PopupScreen>.from(
            json["popup_screen"].map((x) => PopupScreen.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "app_config": List<dynamic>.from(homeBanner.map((x) => x.toJson())),
      };
}
...
/*class AppConfig {
  ...
  AppConfig({this.perPage, this.multiFilter, this.multiFilterJoinString});
...
class AppConfig {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['refund_policy_link'] = this.refundPolicyLink;
...
final classFilterTypeValues = EnumValues({"class": ClassFilterType.CLASS});
...
final publisherFilterTypeValues =
    EnumValues({"publisher": PublisherFilterType.PUBLISHER});
...
final subjectFilterTypeValues =
    EnumValues({"subject": SubjectFilterType.SUBJECT});
...
final boardValues = EnumValues({"CBSE": Board.CBSE, "ICSE": Board.ICSE});
