...
FilterClassCategoryModel filterClassCategoryModelFromJson(String str) =>
    FilterClassCategoryModel.fromJson(json.decode(str));

String filterClassCategoryModelToJson(FilterClassCategoryModel data) =>
...
class FilterClassCategoryModel {
  ...
  factory FilterClassCategoryModel.fromJson(Map<String, dynamic> json) =>
      FilterClassCategoryModel(
        status: json["status"],
...
class Response {
  ...
  factory Response.fromJson(Map<String, dynamic> json) => Response(
        ...
        product: List<ProductClass>.from(
            json["product"].map((x) => ProductClass.fromJson(x))),
      );
