                          ...
                          child: Column(
                            children: [
                              ...
                              snapshot.data.response[0].product.length > 0
                                                              ...
                                                              builder: (_,
                                                                ...
                                                                onTap: () {
                                                                  Provider.of<HomeScreenProvider>(
                                                                          ...
                                                                          listen:
                                                                              false)
                                                                      .selectedTitle = "${snapshot.data.response[0].category[index].categoryName}";

                                                                  Provider.of<HomeScreenProvider>(
                                                                          context,
                                                                          listen:
                                                                              false)
                                                                      .selectedString = "CategoryInfo";
                                                                  _categoryProvider.selectedCategoryName = snapshot
                                                                      .data
                                                                      .response[
                                                                          0]
                                                                      .category[
                                  ...
                                  : SizedBox(),
                              SizedBox(height: 5.0),
                              snapshot.data.response[0].responseClass.length > 0
                                  ? Column(
                                      children: [
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                  ...
                                  : SizedBox(),
                              snapshot.data.response[0].subject.length > 0
                                  ? Column(
                                      children: [
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                  ...
                                  : SizedBox(),
                              snapshot.data.response[0].school.length > 0
                                  ? Column(
                                      children: [
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                  ...
                                  : SizedBox(),
                              snapshot.data.response[0].publisher.length > 0
                                  ? Column(
                                      children: [
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
