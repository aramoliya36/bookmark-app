...
class SchoolInfo extends StatefulWidget {
  ...
  const SchoolInfo({this.schoolSlug});
                  ...
                  child: Column(
                    children: [
                      ...
                      snapshot.data.response.length > 0
                          ? snapshot.data.response[0].schoolCat.length > 0
                              ? FutureBuilder(
                                  ...
                                  builder: (context, subCatSnapshot) {
                                    if (subCatSnapshot.hasData) {
                                      if (subCatSnapshot.data.response.length >
                                          0) {
                                        return Column(
                                          children: [
                                            Padding(
                                            ...
                                            Container(
                                                ...
                                                child: ListView.builder(
                                                  ...
                                                  itemBuilder:
                                                      (context, index) {
                                                    log("PRODUCT SELECTED TYPE ${_schoolProvider.selectedSchoolProductType}");
                                                    log("PRODUCT TYPE ${subCatSnapshot.data.response[0].productType}");
                                                    ...
                                                    if (_schoolProvider
                                                      ...
                                                      if (subCatSnapshot
                                                              ...
                                                              .productType ==
                                                          "Single") {
                                                        log("SINGLE PRODUCT LEN ${subCatSnapshot.data.response.length}");
                                                      ...
                                                      if (subCatSnapshot
                                                              ...
                                                              .productType ==
                                                          "Set") {
                                                        log("SET PRODUCT LEN ${subCatSnapshot.data.response.length}");
