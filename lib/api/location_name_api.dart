...
class LocationNameAPI {
  ...
  static Future getAllCountryName() async {
    String url =
        "$kBaseURL/app/get_school_countries/1595922619X5f1fd8bb5f332/MOB";
  ...
  static Future getAllStateOfCountry(int countryId) async {
    String url =
        "$kBaseURL/app/get_school_states_by_country_id/1595922619X5f1fd8bb5f332/MOB/$countryId";
    // String url =
  ...
  static Future getAllCityOfState(int stateId) async {
    String url =
        "$kBaseURL/app/get_school_city_by_state_id/1595922619X5f1fd8bb5f332/MOB/$stateId";
