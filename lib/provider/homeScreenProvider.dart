...
class HomeScreenProvider extends ChangeNotifier {
  ...
  set oldSelectedIndex(int value) {
  ...
  /// selected title name....
  String _drawerSelectedTitle = "";

  String get drawerSelectedTitle => _drawerSelectedTitle;

  set drawerSelectedTitle(String value) {
    _drawerSelectedTitle = value;
    notifyListeners();
  }
