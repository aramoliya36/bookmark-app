...
class FilterCategoryProvider extends ChangeNotifier {
  ...
  /// selected publisher slug....
  String _selectedFilterCategoryBrandSlug;

  String get selectedFilterCategoryBrandSlug =>
      _selectedFilterCategoryBrandSlug;

  set selectedFilterCategoryBrandSlug(String value) {
    _selectedFilterCategoryBrandSlug = value;
    notifyListeners();
  }
}
